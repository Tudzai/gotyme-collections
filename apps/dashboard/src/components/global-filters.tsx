...
export function GlobalFilters() {
  ...
  function removeChip(key: keyof FilterState) {
    ...
    setFilter(key, val as FilterState[typeof key])
  }
  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen}>
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
            {chips.map(chip => (
              <Badge
                key={chip.key}
                variant="secondary"
                className="text-xs h-6 gap-1 font-normal"
              >
      ...
      <CollapsibleContent>
        <div className="mt-3 p-4 border rounded-lg bg-muted/30 flex flex-col gap-4">
          {/* Date presets */}
          <div className="flex flex-col gap-1">
          ...
          <div className="flex flex-row flex-wrap gap-3 items-end">
            <FilterField label="Product">
              <Select
                ...
                onValueChange={(v) => setFilter('product', v as FilterState['product'])}
              >
            ...
            <FilterField label="Risk Level">
              <Select
                ...
                onValueChange={(v) => setFilter('riskLevel', v as FilterState['riskLevel'])}
              >
            ...
            <FilterField label="Due Window">
              <Select
                ...
                onValueChange={(v) => setFilter('dueWindow', v as FilterState['dueWindow'])}
              >
                <SelectTrigger className="w-[120px] h-8 text-xs">
                  <SelectValue />
                </SelectTrigger>
            ...
            <FilterField label="Channel">
              <Select
                ...
                onValueChange={(v) => setFilter('channel', v as FilterState['channel'])}
              >
                <SelectTrigger className="w-[120px] h-8 text-xs">
                  <SelectValue />
                </SelectTrigger>
